...
int main() {  
  ...
  for (int t = 0; t < time_steps; ++t) {
    ...
    for (unsigned int i = 0; i < map_size; ++i) {
       ...
       */
      float motion_model_prob=motion_model(pseudo_position, movement_per_timestep, priors, map_size, control_stdev);
       ...
       */
      posteriors[i]= motion_model_prob*observation_prob;
