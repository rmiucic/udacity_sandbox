...
vector<Vehicle> Vehicle::choose_next_state(map<int, vector<Vehicle>> &predictions) {
   ...
   */
    vector<string> possible_new_states=successor_states();
	vector<float> costs;
	vector<vector<Vehicle>> final_trajectories
    for(vector<string>::iterator it = possible_new_states.begin(); it != possible_new_states.end(); ++it) 
    {
        /* std::cout << *it; ... */
        vector<Vehicle> trajectory_for_state = generate_trajectory(*it, predictions);
